...
const envSchema = z.object({
  ...
  /** Must match node-realtime FORGE_SOCKET_PATH (Socket.IO engine path). */
  NEXT_PUBLIC_REALTIME_SOCKET_PATH: z.string().default("/socket"),
...
export const env = envSchema.parse({
  ...
  NEXT_PUBLIC_REALTIME_SOCKET_PATH: process.env.NEXT_PUBLIC_REALTIME_SOCKET_PATH,
